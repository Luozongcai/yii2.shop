 ...
 */
class m171105_140400_create_goods_table extends Migration
{
    /**
     * @inheritdoc
     */
    public function up()
    {
        $this->createTable('goods', [
            ...
            'goods_category_id'=>$this->integer(3)->comment('商品分类id'),
            'brand_id'=>$this->integer()->comment('品牌分类'),
            'market_price'=>$this->decimal(3)->comment('市场价格'),
            'shop_price'=>$this->decimal(3)->comment('商品价格'),
