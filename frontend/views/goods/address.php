				...
				<ul>
					...
					<li>
                        ...
                        if(\Yii::$app->user->isGuest) {
                            ...
                            echo '[<a href="<?=\yii\helpers\Url::to(["member/login"])?>">登录</a>] [<a href="<?=\yii\helpers\Url::to(["member/regist"])?>">免费注册</a>]';
                        }else
	...
	<div class="main w1210 bc mt10">
		...
		<div class="content fl ml10">
			<div class="address_hd">
				...
				<dl>
                    <dt><?=$model->id?>&nbsp; <?=$model->name?>&nbsp;<?=$model->cmbProvince?>&nbsp;<?=$model->cmbCity?>&nbsp;<?=$model->cmbArea?>&nbsp;<?=$model->url?>&nbsp;<?=$model->tel?> </dt>
						<dd>
						<a href="<?=\yii\helpers\Url::to(['edit'])?>?id=<?=$model->id?>">修改</a>
						<a href="<?=\yii\helpers\Url::to(['delete'])?>?id=<?=$model->id?>">删除</a>
			...
			<div class="address_bd mt10">
				<h4>新增收货地址</h4>
				<form action="<?=\yii\helpers\Url::to(['url'])?>" name="address_form" method="post">
						<ul>
							<li>
							...
							<li>
								...
								<input type="text" name="url" class="txt address"  />
							</li>
							<li>
							...
							<li>
								<label for="">&nbsp;</label>
								<input type="checkbox" name="check" class="check" value="1"/>设为默认地址
							</li>
							<li>
								<label for="">&nbsp;</label>
...
<script type="text/javascript">
            addressInit('cmbProvince', 'cmbCity', 'cmbCity');
</script>
</body>
</html>
