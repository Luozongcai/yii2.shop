...
<body>
	...
	<div class="mycart w990 mt10 bc">
		...
		<table>
           ...
           <!-- --><?/*=\frontend\models\Cart::getListCars()*/?>
            <tbody>
            <?php foreach ($models as $model):?>
                <tr data-id="<?=$model->id?>">
                    <td class="col1"><a href=""><img src="<?=Yii::$app->params['backend_domain'].$model->logo?>" alt="" /></a>
                        <strong><a href="<?=\yii\helpers\Url::to(["goods/goods"])?>?id=<?=$model->id?>"><?=$model->name?></a></strong></td>
                    <td class="col3">￥<span><?=$model->shop_price?>.00</span></td>
                    <td class="col4">
                    ...
                    <td class="col6"><a href="<?=\yii\helpers\Url::to(["goods/del-cart"])?>?goods_id=<?=$model->id?>">删除</a></td>
                </tr>
            <?php endforeach;?>
            </tbody>
            <tfoot>
