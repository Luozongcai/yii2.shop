...
<body>
	...
	<div class="header w1210 bc mt15">
		...
		<div class="logo w1210">
                ...
                <dl>
                    ...
                    <dd>
                        <div class="prompt">
                            <?php
                            if(\Yii::$app->user->isGuest) {
                                $url1 = \yii\helpers\Url::to(["member/login"]);
                                echo "您好，请";
                                echo "[<a href='{$url1}'>登录</a>]";
                            }else {
                                $name = \Yii::$app->user->identity->username;
                        ...
                        <div class="uclist mt10">
                            <ul class="list1 fl">
                                <li><a href="<?=\yii\helpers\Url::to(["goods/user"])?>">用户信息></a></li>
                                <li><a href="<?=\yii\helpers\Url::to(["order/list"])?>">我的订单></a></li>
                                <li><a href="<?=\yii\helpers\Url::to(["goods/address"])?>">收货地址></a></li>
                                <li><a href="">我的收藏></a></li>
                            </ul>
			...
			<div class="cart fl">
				<dl>
					<dt>
						<a href="<?=\yii\helpers\Url::to(["goods/cars"])?>">去购物车结算</a>
						<b></b>
					</dt>
					<dd>
						<div class="prompt">
	...
	<div class="main w1210 mt10 bc">
		...
		<div class="breadcrumb">
			<h2>当前位置：<a href="<?=\yii\helpers\Url::to(["goods/index"])?>">首页</a> > <a href="">电脑、办公</a> > <a href="">笔记本</a> > ThinkPad X230(23063T4）12.5英寸笔记本</h2>
		</div>
		<!-- 面包屑导航 end -->
		...
		<div class="goods_content fl mt10 ml10">
			<!-- 商品概要信息 start -->
			<div class="summary">
				<h3><strong><?=$goods->name?>（  WIN8PRC 七天包退 一个月包换 一年保修 ）</strong></h3>
				
				<!-- 图片预览区域 start -->
				<div class="preview fl">
					<div class="midpic">
						<a href="http://admin.yii2shop.com/<?=$goods->logo?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="http://admin.yii2shop.com/<?=$goods->logo?>" style="top: 144.5px; left: 229px; width: 340px; height: 340px; alt="" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
                               ...
                               <?php
                               $models=\backend\models\GoodsGallery::find()->where(['goods_id'=>$goods->id])->all();
                               foreach ($models as $k1=>$model):?>
								<li <?=$k1==0?'class="cur"':''?>>
									<a href="javascript:void(0);" <?=$k1==0?'class="zoomThumbActive"':''?> rel="{gallery: 'gal1', smallimage: '<?=Yii::$app->params['backend_domain'].$model->path?>',largeimage: '<?=Yii::$app->params['backend_domain'].$model->path?>'}">
                                        <img src="<?=Yii::$app->params['backend_domain'].$model->path?>"></a>
								</li>
                                <?php endforeach;?>
