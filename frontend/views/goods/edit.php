...
<div class="main w1210 bc mt10">
    ...
    <div class="content fl ml10">
        ...
        <div class="address_bd mt10">
            <h4>修改收货地址</h4>
            <form action="<?=\yii\helpers\Url::to(['edit'])?>?id=<?=$model->id?>" name="address_form" method="post">
                <ul>
                    <li>
                        <label for=""><span>*</span>收 货 人：</label>
                        <input type="text" name="name" value="<?=$model->name?>" class="txt" />
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <input type="text" name="url"  value="<?=$model->url?>"class="txt address"  />
                    </li>
                    <li>
                        <label for=""><span>*</span>手机号码：</label>
                        <input type="text" name="tel"value="<?=$model->tel?>" class="txt" />
                    </li>
                    <li>
                        <label for="">&nbsp;</label>
...
<script type="text/javascript">
    addressInit('cmbProvince', 'cmbCity', 'cmbArea','<?=$model->cmbProvince?>','<?=$model->cmbCity?>','<?=$model->cmbArea?>');
</script>
</body>
</html>