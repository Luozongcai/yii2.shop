		...
		<div class="content fl ml10">
			...
			<div class="order_bd mt10">
				<table class="orders">
					...
					<tbody>
                    <?php $statuss=[0=>'已取消',1=>'待付款',2=>'待发货',3=>'待收货',4=>'完成']; foreach ($models as $model):
                        $logos=\frontend\models\OrderGoods::find()->where(['order_id'=>$model->id])->all();
                        ?>
						<tr>
							...
							<td><a href="">
                                    ...
                                    if ($key<3){
                                      echo '<img src="'.Yii::$app->params['backend_domain'].$logo->logo.'"/>';}
                                    } ?>
                                </a></td>

							<td><?=$model->name?></td>
							<td>￥<?=$model->total?>.00 <?=$model->payment_name?></td>
							<td><?=date('Y-m-d H:i:s',$model->create_time)?></td>
							<td><?=$statuss[$model->status]?></td>
